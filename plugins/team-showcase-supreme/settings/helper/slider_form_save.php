...
$temname = $_POST['template_name'];
$memberorder = $_POST['custom_css'];

$wpdb->query($wpdb->prepare("UPDATE $style_table SET name = %s, css = %s, slider = %s, memberorder=%s WHERE id = %d", $temname, $css, $slider, $memberorder, $styleId));
