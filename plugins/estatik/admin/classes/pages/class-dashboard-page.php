...
class Es_Dashboard_Page extends Es_Object
{
    ...
    public static function get_changelog_list()
    {
        return apply_filters( 'es_get_changelog_list', array(
	        __( '3.11.11 (February, 10, 2022)', 'es-plugin' ) => '<ul>
				<li>FIX: Gallery in property PDF fixed (all versions)</li>
				<li>FIX: Slideshow widget styles in Elementor fixed (all versions)</li>
				<li>FIX: mls_class and mls_resource attributes added to es_my_listing shortcode (Premium)</li>
				<li>FIX: MLS Realty server rets dmql2 query fixed (Premium)</li>
				<li>FIX: build_fields_array class method set as public (Premium)</li>
				<li>FIX: MLS media import for mls grid v2 implemented (Premium)</li>
				<li>FIX: minor fixes</li>
			</ul>',

	        __( '3.11.10 (January, 27, 2022)', 'es-plugin' ) => '<ul>
				<li>FIX: Magnific popup arrows fixed (all versions)</li>
				<li>FIX: Search form fixed for numeric fields (all versions)</li>
				<li>FIX: Listings archive responsive issues fixed</li>
				<li>FIX: Delete duplicates functionality implemented on property import action (Premium)</li>
				<li>FIX: IN query operator implemented for Trestle web API (Premium)</li>
			</ul>',

	        __( '3.11.9 (January, 11, 2022)', 'es-plugin' ) => '<ul>
				<li>NEW: Pre-defined search form values as comma-separated feature added (all versions)</li>
				<li>NEW: CSV Import support added for Post Content field (Premium)</li>
				<li>FIX: Сropping photos in gallery fixed (all versions)</li>
				<li>FIX: Slick slider in gallery fixed (all versions)</li>
				<li>FIX: PDF light fonts fixed (PRO & Premium)</li>
				<li>FIX: Lot_size & area units search widget fixed (all versions)</li>
				<li>FIX: Featured image on single property page for Divi theme disabled (all versions)</li>
				<li>FIX: Listings query for Fields Builder select fields fixed (all versions)</li>
