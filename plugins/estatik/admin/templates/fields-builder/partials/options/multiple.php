...
$iterator = new ArrayIterator( $values ); ?>
    ...
    <ul class="js-es-sortable">

		<?php do{ ?>
            <li class="es-clone__wrap">
                <div class="es-field">
                    ...
                    <div class="es-field__content">
                        ...
                        <input placeholder="<?php _e( '-- Input value --', 'es-plugin' ); ?>"
                               type="text" name="fbuilder[values][]" value="<?php echo ! empty( $values[ $iterator->key() ] ) ? esc_attr( stripslashes( $values[ $iterator->key() ] ) ) : ''; ?>"/>
