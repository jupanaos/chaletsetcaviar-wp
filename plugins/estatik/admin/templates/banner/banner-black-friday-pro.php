...
<div data-notice="es-coupon-notice" class="es-notice es-notice__coupon notice is-dismissible">
	...
	<div class="es-notice__content">
        ...
        <p style="font-weight: normal; font-size: 12px; line-height: 150%; color: #FFFFFF;">Upgrade to <a href="https://estatik.net/product/best-offer/" target="_blank">Developer's Pack</a> just for $30 use coupon <b style="text-transform: uppercase; font-weight: bold;">blackdev</b></p>
        <p style="font-weight: normal; font-size: 12px; line-height: 150%; color: #FFFFFF;">Become <a href="https://estatik.net/product/estatik-premium-rets/" target="_blank">Premium</a> and unlock MLS Import via RETS/Web API with a 20% off discount use coupon <b style="font-weight: bold;text-transform: uppercase;">blackpremium</b></p>
	</div>
</div>