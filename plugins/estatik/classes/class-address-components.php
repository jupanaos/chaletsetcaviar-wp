...
class ES_Address_Components {
	 ...
	 * @param null $type
	 */
    public static function save_property_component( $property_id, $component_id, $type = null ) {
        ...
        if ( $component = static::get_component( $component_id ) ) {
			...
			$type = $type ? $type : $component->type;
            add_post_meta( $property_id, '_address_component_' . $type, $component_id );
        }
    }
